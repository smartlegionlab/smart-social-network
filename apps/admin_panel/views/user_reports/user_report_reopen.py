...
@superuser_required
def user_report_reopen_view(request, report_id):
    msg = 'Successfully reopened the report!'
    return user_report_status_change_view(request, report_id, 'in_progress', msg)
