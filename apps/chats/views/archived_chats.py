...
@login_required
def archived_chat_list_view(request):
    ...
    archived_chats_count = chat_list.count()
    page = request.GET.get('page', 1)
    paginator = CachedCountPaginator(chat_list, 40, archived_chats_count)
    ...
    return render(request, 'chats/archived_chat_list.html', context)
